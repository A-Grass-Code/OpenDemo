...
namespace IZhy.Common.DbTools
{
    ...
    internal sealed class DbOperationTool : IDbOperation
    {
        ...
        /// </summary>
        /// <returns></returns>
        public Dictionary<string, string> GetConnStringInfo()
        {
            ...
            Dictionary<string, string> connKeyValues = new Dictionary<string, string>();
            foreach (string item in connArr)
            {
                ...
                connKeyValues.Add(attribute[0].Trim(), attribute[1].Trim());
            }
            return connKeyValues;
        }
        ...
        /// <summary>
        /// 返回有效的 sql 执行的超时时间，单位 秒
        /// <para>有效值范围 1~60</para>
        /// </summary>
        /// <param name="sqlExeTimeout">sql 执行的超时时间，单位 秒</param>
        /// <returns></returns>
        private int ValidSqlExeTimeout(int sqlExeTimeout)
        {
            if (sqlExeTimeout < 1)
            {
                sqlExeTimeout = 1;
        ...
        public dynamic QueryBySql(string sql, object param = null, int sqlExeTimeout = 20)
        {
            try
            {
                ...
                dynamic dyData = DbConn.Query(sql, param, Transaction, true, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return dyData;
            }
            catch (Exception ex)
            {
        ...
        public List<T> QueryBySql<T>(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
                var data = DbConn.Query<T>(sql, param, Transaction, true, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return data.ToList();
            }
            catch (Exception ex)
            {
        ...
        public object ExecuteScalar(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            try
            {
                object obj = DbConn.ExecuteScalar(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return obj;
            }
            catch (Exception ex)
            {
        ...
        public T ExecuteScalar<T>(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                T obj = DbConn.ExecuteScalar<T>(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return obj;
            }
            catch (Exception ex)
            {
        ...
        public dynamic QueryFirst(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                dynamic dyData = DbConn.QueryFirstOrDefault(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return dyData;
            }
            catch (Exception ex)
            {
        ...
        public T QueryFirst<T>(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                T dyData = DbConn.QueryFirstOrDefault<T>(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return dyData;
            }
            catch (Exception ex)
            {
        ...
        public dynamic QuerySingle(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                dynamic dyData = DbConn.QuerySingleOrDefault(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return dyData;
            }
            catch (Exception ex)
            {
        ...
        public T QuerySingle<T>(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                T dyData = DbConn.QuerySingleOrDefault<T>(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return dyData;
            }
            catch (Exception ex)
            {
        ...
        public int ExecuteSql(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
        ...
        public int ExecuteProcedure(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, param, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.StoredProcedure);
                return rows;
            }
            catch (Exception ex)
            {
        ...
        public dynamic QueryProcedure(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
                dynamic dyData = DbConn.Query(sql, param, Transaction, true, ValidSqlExeTimeout(sqlExeTimeout), CommandType.StoredProcedure);
                return dyData;
            }
            catch (Exception ex)
            {
        ...
        public List<T> QueryProcedure<T>(string sql, object param = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, bool buffered = true, int? commandTimeout = null, CommandType? commandType = null
                var data = DbConn.Query<T>(sql, param, Transaction, true, ValidSqlExeTimeout(sqlExeTimeout), CommandType.StoredProcedure);
                return data.ToList();
            }
            catch (Exception ex)
            {
        ...
        public int ExeInsertSql(string tableName, Dictionary<string, object> dicFields, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, dicFields, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
        ...
        public int ExeBatchInsertSql(string tableName, List<Dictionary<string, object>> listFields, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, listFields, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
            ...
            Dictionary<string, object> dicWhere, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, dicParams, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
            ...
            List<Dictionary<string, object>> listDicWhere, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, listDicParams, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
        ...
        public int ExeDeleteSql(string tableName, Dictionary<string, object> dicWhere, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, dicWhere, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
        ...
        public int ExeBatchDeleteSql(string tableName, List<Dictionary<string, object>> listWhere, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var rows = DbConn.Execute(sql, listWhere, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                return rows;
            }
            catch (Exception ex)
            {
        ...
        public DataTable SelectATableByANDEqualSignToDt(string tableName, string[] fields, Dictionary<string, object> dicWhere, string[] orderBy = null, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                var data = DbConn.ExecuteReader(sql, dicWhere, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                DataTable dataTable = new DataTable();
                dataTable.Load(data);
                return dataTable;
            }
        ...
        public bool CheckATableDataExist(string tableName, Dictionary<string, object> dicWhere, int sqlExeTimeout = 20)
        {
            ...
            {
                // string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
                int count = DbConn.ExecuteScalar<int>(sql, dicWhere, Transaction, ValidSqlExeTimeout(sqlExeTimeout), CommandType.Text);
                if (count > 0)
                {
                    return true;
                }
